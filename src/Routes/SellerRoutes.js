...
const { logout, getSellers, login, addProduct, getProducts, getImages, getModel, deleteProduct, updateImage, updateModel, updateProduct } = require('../Controller/sellerController')
